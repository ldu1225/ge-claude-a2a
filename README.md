...
| 💬 Gemini Enterprise 채팅창 | 🖥️ Cloud Workstations 웹 IDE | 📱 모바일 앱 (이동 중 지시) |
| :--- | :--- | :--- |
| ![GE Chat](https://static.zenn.studio/user-upload/3c3d4752700b-20260424.gif) | ![Web IDE](gif/SessionRsume.gif) | ![Mobile App](gif/phoneStart.gif) |
| 대화창 내부에서 실시간 빌드 상황을 직관적인 그래픽 대시보드로 관제하고 인터랙티브 위젯으로 세부 설정을 제어합니다. | 브라우저 전용 VS Code 환경에서 에이전트가 실시간 작성 중인 소스코드를 직접 수정하고 디버깅할 수 있습니다. | 이동 중 스마트폰 제미나이 앱으로 가상 머신에 명령을 내리면, 백그라운드에서 빌드와 테스트가 자율적으로 완수됩니다. |
